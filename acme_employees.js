...
function findEmployeeByName(employeeName, arr) {
  //{ id: 1, name: "moe" },
  return arr.filter((element) => element.name === employeeName)[0];
  //   const filteredArr = arr.filter((element) => element.name === employeeName)[0]
...
function findManagerFor(obj, arr) {
  return arr.filter((element) => element.id === obj.managerId)[0];
}
